...
public class MethodReferencePractice2 {
	...
	public static void main(String[] args) {
		...
		performOperation(employeeList, p -> true, System.out::println);
		System.out.println("---------------------");
		performOperation(employeeList, p -> p.getFirstName().startsWith("U"),System.out::println);
		System.out.println("=====================");
		performOperation(employeeList, p -> p.getFirstName().startsWith("A"),
				p->System.out.println(p.getEmployeeId()));
	}
